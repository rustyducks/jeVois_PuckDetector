...
class PuckDetector:
    ...
    def __init__(self):
        ...
        self.colors_thre = {"green": [(42, 70, 100), (70, 255, 255)], "blue": [(95, 100, 100), (120, 255, 255)], "red": [(0, 100, 100), (10, 255, 255)]}
    ...
    def processNoUSB(self, inframe):
        ...
        for d_color in self.colors_thre.keys():
            ...
            for pt in puck_poses:
                cv2.line(img_poses, (pt[0] - 5, pt[1]), (pt[0] + 5, pt[1]), (0, 255, 255))
                cv2.line(img_poses, (pt[0], pt[1] - 5), (pt[0], pt[1] + 5), (255, 255, 0))
            ...
            for c in filtered_contours:
                ...
                cv2.line(img_poses, (center_pose[0] - 5, center_pose[1]), (center_pose[0] + 5, center_pose[1]),
                         self.colors_thre[d_color][0])
                cv2.line(img_poses, (center_pose[0], center_pose[1] - 5), (center_pose[0], center_pose[1] + 5),
                         self.colors_thre[d_color][0])

        jevois.sendSerial("R:{}G:{}B:{}\n".format(pucks_color["red"], pucks_color["green"], pucks_color["blue"]));
    # ###################################################################################################
    ...
    def process(self, inframe, outframe):
        ...
        for d_color in self.colors_thre.keys():
            ...
            for c in filtered_contours:
              ...
              pucks_color[d_color].append(center_pose)
              cv2.line(img_poses, (center_pose[0]-5, center_pose[1]), (center_pose[0]+5, center_pose[1]), self.colors_thre[d_color][0])
              cv2.line(img_poses, (center_pose[0], center_pose[1]-5), (center_pose[0], center_pose[1]+5), self.colors_thre[d_color][0])
